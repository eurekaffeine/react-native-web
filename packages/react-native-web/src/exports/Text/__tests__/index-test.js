...
describe('components/Text', () => {
  ...
  test('nested', () => {
    const { container } = renderRootView(
      <Text children={<Text testID="child" />} />
    );
    expect(container.firstChild).toMatchSnapshot();
  });
  ...
  describe('prop "accessibilityLabelledBy"', () => {
    test('value is set', () => {
      const { container } = renderRootView(
        <Text accessibilityLabelledBy="123" />
      );
      expect(container.firstChild).toMatchSnapshot();
    });
  });
  ...
  describe('prop "accessibilityRole"', () => {
    ...
    test('value alters HTML element', () => {
      const { container } = renderRootView(
        <Text accessibilityRole="article" />
      );
      expect(container.firstChild).toMatchSnapshot();
    });
  });
  ...
  describe('prop "dir"', () => {
    test('value is "ltr"', () => {
      const { container } = renderRootView(<Text dir="ltr" />);
      expect(container.firstChild).toMatchSnapshot();
    });
  ...
  describe('prop "lang"', () => {
    ...
    test('ar', () => {
      const { container } = renderRootView(<Text lang="ar" />);
      expect(container.firstChild).toMatchSnapshot();
    });

    test('with dir', () => {
      const { container } = renderRootView(<Text dir="ltr" lang="ar" />);
      expect(container.firstChild).toMatchSnapshot();
    });
  });
